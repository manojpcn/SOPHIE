...
const Risks = React.lazy(() => import('./views/dashboard/Risks'))
const Compliance = React.lazy(() => import('./views/dashboard/Compliance'))
...
const routes = [
  ...
  { path: '/dashboard/risks', name: 'Risks', element: Risks },
  { path: '/dashboard/compliance', name: 'Compliance', element: Compliance },
